...
fun WithKirinukiTextToolbar(content: @Composable () -> Unit) {
    ...
    CompositionLocalProvider(LocalTextToolbar provides KirinukiTextToolbar(LocalView.current, activityLauncher)) {
        content()
    }
}

class KirinukiTextToolbar(
    private val view: View,
    activityLauncher: ActivityLauncher,
) : TextToolbar {
    private var actionMode: ActionMode? = null
    private val textActionModeCallback: KirinukiTextActionModeCallback =
        KirinukiTextActionModeCallback(
...
class KirinukiTextActionModeCallback(
    val context: Context,
...
internal class FloatingTextActionModeCallback(
    private val callback: KirinukiTextActionModeCallback,
